...
hãy cho tôi promt để tôi yêu cầu midjouney tạo ảnh cho từng cảnh. Phải đồng nhất về mô tả hình ảnh con mèo qua các cảnh, để người xem hiểu là cùng là 1 con trong kịch bản chứ không phải là 2 con. Bạn KHÔNG cần tạo ảnh, chỉ cần viết câu lệnh cho tất cả các cảnh ở trên thôi nhưng vẫn thể hiện . Hãy làm hết từng cảnh, giữ nguyên các từ khoá mô tả ngoại hình, thay đổi đối tượng tương tác qua từng cảnh. Bức ảnh chỉ cần đơn giản giống như được tạo ra bằng AI, không cần hoàn toàn tự nhiên. Tuy nhiên, nó vẫn là một bức ảnh thú vị và hài hước,
